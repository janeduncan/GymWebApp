...
member1 = Member.new({ "first_name" => "Jane", "last_name" => "Duncan", "membership_id" => membership2.id })
member2 = Member.new({ "first_name" => "Kirsty", "last_name" => "Bruce", "membership_id" => membership1.id })
member3 = Member.new({ "first_name" => "Craig", "last_name" => "Bowditch", "membership_id" => membership2.id })
member4 = Member.new({ "first_name" => "Andrew", "last_name" => "Craigie", "membership_id" => membership1.id })
member5 = Member.new({ "first_name" => "Connie", "last_name" => "Leighton", "membership_id" => membership2.id })
member6 = Member.new({ "first_name" => "Fiona", "last_name" => "Wilson", "membership_id" => membership1.id })
member7 = Member.new({ "first_name" => "Ricky", "last_name" => "Corrigan", "membership_id" => membership2.id })
member8 = Member.new({ "first_name" => "Shannon", "last_name" => "Holmes", "membership_id" => membership1.id })
member9 = Member.new({ "first_name" => "Pim", "last_name" => "Groenveld", "membership_id" => membership2.id })
member10 = Member.new({ "first_name" => "Sithara", "last_name" => "Sukumar", "membership_id" => membership1.id })
member11 = Member.new({ "first_name" => "Fraser", "last_name" => "Douglas", "membership_id" => membership2.id })
member12 = Member.new({ "first_name" => "Yingying", "last_name" => "Chen", "membership_id" => membership1.id })
member13 = Member.new({ "first_name" => "Anne", "last_name" => "Ince", "membership_id" => membership2.id })
member14 = Member.new({ "first_name" => "Tanny", "last_name" => "Quereshi", "membership_id" => membership1.id })
member15 = Member.new({ "first_name" => "Rameez", "last_name" => "Tariq", "membership_id" => membership2.id })
member16 = Member.new({ "first_name" => "Robert", "last_name" => "Deignan", "membership_id" => membership1.id })
member17 = Member.new({ "first_name" => "Kaspars", "last_name" => "Dzerins", "membership_id" => membership2.id })
member18 = Member.new({ "first_name" => "Christian", "last_name" => "Geib", "membership_id" => membership1.id })
member19 = Member.new({ "first_name" => "Ally", "last_name" => "McGilloway", "membership_id" => membership2.id })
member20 = Member.new({ "first_name" => "Upul", "last_name" => "Dissanayaka", "membership_id" => membership1.id })
member21 = Member.new({ "first_name" => "Alistair", "last_name" => "Kane", "membership_id" => membership2.id })
member22 = Member.new({ "first_name" => "Alan", "last_name" => "Russell", "membership_id" => membership1.id })
member1.save()
member2.save()
member3.save()
member4.save()
