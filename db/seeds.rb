...
member1 = Member.new({ "first_name" => "Jane", "last_name" => "Duncan", "membership_type" => membership2 })
member2 = Member.new({ "first_name" => "Kirsty", "last_name" => "Bruce", "membership_type" => membership1 })
member3 = Member.new({ "first_name" => "Craig", "last_name" => "Bowditch", "membership_type" => membership2 })
member4 = Member.new({ "first_name" => "Andrew", "last_name" => "Craigie", "membership_type" => membership1 })
member5 = Member.new({ "first_name" => "Connie", "last_name" => "Leighton", "membership_type" => membership2 })
member6 = Member.new({ "first_name" => "Fiona", "last_name" => "Wilson", "membership_type" => membership1 })
member7 = Member.new({ "first_name" => "Ricky", "last_name" => "Corrigan", "membership_type" => membership2 })
member8 = Member.new({ "first_name" => "Shannon", "last_name" => "Holmes", "membership_type" => membership1 })
member9 = Member.new({ "first_name" => "Pim", "last_name" => "Groenveld", "membership_type" => membership2 })
member10 = Member.new({ "first_name" => "Sithara", "last_name" => "Sukumar", "membership_type" => membership1 })
member11 = Member.new({ "first_name" => "Fraser", "last_name" => "Douglas", "membership_type" => membership2 })
member12 = Member.new({ "first_name" => "Yingying", "last_name" => "Chen", "membership_type" => membership1 })
member13 = Member.new({ "first_name" => "Anne", "last_name" => "Ince", "membership_type" => membership2 })
member14 = Member.new({ "first_name" => "Tanny", "last_name" => "Quereshi", "membership_type" => membership1 })
member15 = Member.new({ "first_name" => "Rameez", "last_name" => "Tariq", "membership_type" => membership2 })
member16 = Member.new({ "first_name" => "Robert", "last_name" => "Deignan", "membership_type" => membership1 })
member17 = Member.new({ "first_name" => "Kaspars", "last_name" => "Dzerins", "membership_type" => membership2 })
member18 = Member.new({ "first_name" => "Christian", "last_name" => "Geib", "membership_type" => membership1 })
member19 = Member.new({ "first_name" => "Ally", "last_name" => "McGilloway", "membership_type" => membership2 })
member20 = Member.new({ "first_name" => "Upul", "last_name" => "Dissanayaka", "membership_type" => membership1 })
member21 = Member.new({ "first_name" => "Alistair", "last_name" => "Kane", "membership_type" => membership2 })
member22 = Member.new({ "first_name" => "Alan", "last_name" => "Russell", "membership_type" => membership1 })
member1.save()
member2.save()
member3.save()
member4.save()
