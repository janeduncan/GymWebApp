...
class TestSession < MiniTest::Test
  ...
  def setup()
    ...
    options = {"id" => 1, "gym_class_id" => @gymclass, "instructor_id" => @instructor.id(), "studio_id" => @studio.id(), "available_spaces" => 12, "class_time" => "09:00:00", "class_date" => "2018-09-01", "duration" => 30}
